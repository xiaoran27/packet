...
public class SOAPClient4XG {
	public static void main(String[] args) throws Exception {
        ...
        soapClient(SOAPUrl, xmlFile2Send, SOAPAction);
	}
	
	public static void soapClient(String SOAPUrl, String xmlFile2Send ) throws Exception {
		soapClient(SOAPUrl, xmlFile2Send, "");
	}
    public static void soapClient(String SOAPUrl, String xmlFile2Send, String SOAPAction) throws Exception {
